module binary_to_seven_seg( 
    ...
    assign hex_out[0] = num0        + num2 + num3        + num5 + num6 + num7 + num8 + num9 + numA        + numC        + numE + numF;
    ...
    assign hex_out[3] = num0        + num2 + num3        + num5 + num6        + num8 + num9 + numA + numB + numC + numD + numE;

    assign hex_out[4] = num0        + num2               + num5 + num6        + num8 + num9 + numA + numB + numC + numD + numE + numF;
    assign hex_out[5] = num0        + num2 + num3 + num4 + num5 + num6        + num8 + num9 + numA + numB + numC        + numE + numF;
    assign hex_out[6] = num0        + num2 + num3 + num4 + num5 + num6        + num8 + num9 + numA + numB        + numD + numE + numF;
